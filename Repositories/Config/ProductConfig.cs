...
namespace Repositories.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                new Product() { ProductId = 1, CategoryId = 2, ImageUrl="/images/computer.jpg", ProductName = "Computer", Price = 17_000 },
                ...
                new Product() { ProductId = 5, CategoryId = 2, ImageUrl="/images/deck.jpg", ProductName = "Deck", Price = 1_500 },
                new Product() { ProductId = 6, CategoryId = 1, ImageUrl="/images/history.jpg", ProductName = "History", Price = 50 },
                new Product() { ProductId = 7, CategoryId = 1, ImageUrl="/images/hamlet.jpg", ProductName = "Hamlet", Price = 75 }
